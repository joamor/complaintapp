...
import com.complaint.domain.complaint.ComplaintService;
import com.complaint.domain.complaint.EditComplaintCommand;
...
public class ComplaintController {
    ...
    @PatchMapping(value = "/{complaintId}", produces = APPLICATION_JSON_VALUE)
